...
raised to the power of the number of digits in a given base. In this Kata, we
...
bool narcissistic(int value)
{
    ...
    {
        digits[i] = pow(digits[i], digits.size());
    }
    return accumulate(digits.begin(), digits.end(), 0) == orig;
}