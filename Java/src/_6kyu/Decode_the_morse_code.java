...
public class Decode_the_morse_code {
    ...
    public static String decode(String morseCode) {
        /*
         * predefined MorseCode dictionary available in kata environment; ad hoc dictionary below
        ...
        for (int i = 0; i < code.length; i++) {
            kv = MorseCode.get(code[i]);
            decode = kv != null ? kv : " ";
            builder.append(decode);
        }
        String result = builder.toString().trim().replaceAll(" +", " ");
        return result;
    }
}