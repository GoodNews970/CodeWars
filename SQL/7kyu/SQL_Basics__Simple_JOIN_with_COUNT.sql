...
For this challenge you need to create a simple SELECT statement that will return
 all columns from the people table, and join to the toys table so that you can
...
NOTE: You're solution should use pure SQL. Ruby is used within the test cases to
