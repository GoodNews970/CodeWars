...
{
    var packets = packet.match(/.{1,4}/g);
    if (packets[1] == "0F12") var Data3 = parseInt(packets[2]) + parseInt(packets[3]);
    if (packets[1] == "B7A2") var Data3 = parseInt(packets[2]) - parseInt(packets[3]);
    if (packets[1] == "C3D9") var Data3 = parseInt(packets[2]) * parseInt(packets[3]);
    if (Data3 > 9999) Data3 = 9999;
    if (Data3 < 0) Data3 = 0;
    packets[1] = "FFFF", packets[2] = Data3.toString().padStart(4,"0"), packets[3] = "0000";
    return packets.toString().replace(/,/g,"");
}