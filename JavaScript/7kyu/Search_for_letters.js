...
// either '1' or '0' based on the fact whether the Nth letter of the alphabet is
// present in the input (independent of its case).
...
function change(string){
    ...
    alphabet.forEach(element => {
      (string.indexOf(element.toUpperCase()) > -1 | string.indexOf(element) > -1)
      ? ret = ret.concat(1) : ret = ret.concat(0);
    });
    return ret;
  }